# Contributing to Sauce Labs Helm Charts

**Thank you for your interest in Sauce Labs Helm Charts. Your contributions are highly welcome.**
...
- The chart should use Sauce Labs based container images. If they don't exist, you can [open a GitHub issue](https://github.com/saucelabs/helm-charts/issues/new/choose) and we will work together to create them.
